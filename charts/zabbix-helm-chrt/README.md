...
| zabbixProxy.image.tag | string | `"alpine-6.4.3"` | Tag of Docker image of Zabbix proxy |
...
| zabbixAgent.image.tag | string | `"alpine-6.4.3"` | Tag of Docker image of Zabbix agent |
